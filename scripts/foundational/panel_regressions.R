...
# Load data
# ------------------------------------------------------------------------------
sub_samples <- readRDS("data/05_model_output/foundational_sub_samples.rds")
...
table_info <- list(
  "ca_count" = list(
    ...
    file_name = "foundational/01_ca_translational.tex"
  ),
  "tcc" = list(
    vars_to_keep = variable_interest,
    file_name = "foundational/02_tcc_translational.tex"
  ),
  "patent_count" = list(
    vars_to_keep = variable_interest,
    file_name = "foundational/03_patent_count_translational.tex"
  ),
  "patent_citation" = list(
    vars_to_keep = variable_interest,
    file_name = "foundational/04_patent_citation_translational.tex"
  ),
  "ct0" = list(
    vars_to_keep = variable_interest,
    file_name = "foundational/05_ct0_productivity.tex"
  ),
  "ct1" = list(
    vars_to_keep = variable_interest,
    file_name = "foundational/06_ct1_productivity.tex"
  ),
  "num_publications" = list(
    vars_to_keep = variable_interest,
    file_name = "foundational/07_num_publications_productivity.tex"
  ),
  "cited_by_count_std" = list(
    vars_to_keep = variable_interest,
    file_name = "foundational/08_cited_by_count_std_productivity.tex"
  )
)
