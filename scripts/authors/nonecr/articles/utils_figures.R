figures <- "data/05_model_output/authors/nonecr/articles/figures/"
...
coef_order <- c(
  "af:ct_noai", "af:ct_ai", "ct_noai:high_pdb1", "af:high_pdb1",
  "ct_ai:high_pdb1", "ct_noai", "ct_ai", "af",
  "af:ct_noai_ind", "af:ct_ai_ind",
  "ct_noai:high_pdb1_ind", "ct_ai:high_pdb1_ind", "af:high_pdb1_ind",
  "ct_noai_ind", "ct_ai_ind", "af_ind"
)
...
coef_labels <- c(
  ...
  "af:high_pdb1_ind" = "AlphaFold (ext.) - High PDB",
  "ct_ai:high_pdb1_ind" = "Counterfactual AI (ext.) - High PDB", # nolint
  "ct_noai:high_pdb1_ind" = "Counterfactual no AI (ext.) - High PDB", # nolint
  "af" = "AlphaFold (int.)",
  "ct_ai" = "Counterfactual AI (int.)",
  "ct_noai" = "Counterfactual no AI (int.)",
  "af:high_pdb1" = "AlphaFold (int.) - High PDB",
  "ct_ai:high_pdb1" = "Counterfactual AI (int.) - High PDB", # nolint
  "ct_noai:high_pdb1" = "Counterfactual no AI (int.) - High PDB" # nolint
)
      ...
      tryCatch(
        {
          ...
          # add counts of obs (strength all and ext.)
