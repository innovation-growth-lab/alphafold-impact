...
pathdir <- "data/05_model_output/authors/ecr/articles/"
...
for (dep_var_out in dep_vars) { # nolint
  ...
  source("scripts/authors/ecr/articles/utils_tables.R")
  ...
  source("scripts/authors/ecr/articles/utils_figures.R")
