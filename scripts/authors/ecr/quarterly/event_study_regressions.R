...
pathdir <- "data/05_model_output/authors/ecr/quarterly/es/"
...
# ------------------------------------------------------------------------------
sub_samples <- readRDS(
  "data/05_model_output/authors/ecr/quarterly/data/es_sub_samples.rds"
)
...
figures <- "data/05_model_output/authors/ecr/quarterly/figures/es/"
...
saveRDS(
  results,
  "data/05_model_output/authors/ecr/quarterly/data/es_results.rds"
)
